  ...
  fields: [
    {
      ...
      isRequired: true, displayOrder: 1, options: [], cssClass: 'form-control', htmlId: 'field-name', translations: new Map(),
    },
    {
      id: 2, name: 'email', fieldType: 'text', validation: { type: 'email' },
      isRequired: true, displayOrder: 2, options: [], cssClass: 'form-control', htmlId: 'field-email', translations: new Map(),
    },
    {
      id: 3, name: 'message', fieldType: 'textarea', validation: { type: 'none' },
      isRequired: true, displayOrder: 3, options: [], cssClass: 'form-control', htmlId: 'field-message', translations: new Map(),
    },
  ],
